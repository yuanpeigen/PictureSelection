...
public class ImageSelectorView extends FrameLayout implements View.OnClickListener {
    ...
    public ImageSelectorView(Context context, Activity activity, boolean isMultipleChoice, final int maxCount, final List<String> pathList, ImageSelectorListener listener) {
        super(context);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case WHAT_REFRESH_PATH_LIST:
                        if (mAdapter == null) {
                            mAdapter = new ImageSelectorAdapter(mActivity, mPathList);
    ...
    private class ItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (mIsMultipleChoice) {
                ...
                if (mAdapter.getSelectedSet().size() > 0) {
                    ArrayList<String> list = new ArrayList<String>();
                    for (String imagePath : mAdapter.getSelectedSet()) {
